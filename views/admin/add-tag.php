        ...
        <div class="6u$ 12u$(medium)">
            <form method="post" action="#">
                <div class="row uniform">
                    ...
                    <span>Slug</span>
                    <div class="12u$">
                        <input type="text" name="slug" id="demo-name" value="" placeholder="Enter slug" />
                    </div>
                    
                    <span>Tag Description</span>
                    <div class="12u$">
                        <textarea name="tag_desc" id="demo-message" placeholder="Enter description" rows="6"></textarea>
                    </div>
